...
<html>
    ...
    <body>
        <div id="contenedor">
            ...
            <div id="contenido">
                <h2>Cancelar Cita</h2>
                <p>La cancelación de citas se debe realizar con antelación.</p>
                <p><strong>Presencial:</strong> El paciente debe acercarse a ventanilla de asignación de citas;<strong> Lunes a Viernes</strong>                  de 8 am -12 m y de 2:00 pm -6:00 pm.
                <br>
                <strong>Vía telefónica:</strong> El usuario marca el número telefónico de la entidad en horarios de atención.</p>
